    ...
    <div className="h-full overflow-auto p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="min-w-max">
          {/* Header Row */}
          <div className="grid gap-4 mb-6" style={{ gridTemplateColumns: `280px repeat(6, 240px)` }}>
          ...
          {categories.map(category => (
            <div key={category.id} className="grid gap-4 mb-6" style={{ gridTemplateColumns: `280px repeat(6, 240px)` }}>
              {/* Category Header */}
...
const DropCell = ({ id, goals }: DropCellProps) => {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`
        bg-white border-2 border-dashed rounded-xl p-3 min-h-[160px] transition-all duration-200
        ${isOver 
